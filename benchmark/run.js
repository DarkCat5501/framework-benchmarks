...
const ALL_SERVERS = {
  ...
  ultimate: { port: 3006, script: join(__dirname, '..', 'servers', 'ultimate-server.js'), runtime: 'node' },
  fastify: { port: 3007, script: join(__dirname, '..', 'servers', 'fastify-server.js'), runtime: 'node' }
}
